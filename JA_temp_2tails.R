...
tmp2 <- tmp1[which(1901:2016 <=2012 & 1901:2016 >=1981),,which(longitude <= 54 & longitude >=20)]
#crop to 1981:2012
...
tmp2 <- tmp1[which(1901:2016 <=2012 & 1901:2016 >=1981),,which(longitude <= 86 & longitude >=54)]
...
tmp2 <- tmp1[which(1901:2016 <=2012 & 1901:2016 >=1981),,which(longitude <= 180 & longitude >=86)]
...
##########################################################################################################################
t1 <- merge(j1,j2,j3,tolerance = 0.5)
...
#nothing in j6
t <- merge(j4,j5,j7, tolerance = 0.5) 
...
plot(j4,main="",col =rb,breaks = c(-1.5,-1,-0.5,0,0.5,1,1.5),   xlab="",ylab="",horizontal = F,add = T, legend = F)
...
plot(j4,main="",col =rb,breaks = c(-1.5,-1,-0.5,0,0.5,1,1.5),   xlab="",ylab="",horizontal = F,add = T, legend = F)
plot(j5,main="",col =rb,breaks = c(-1.5,-1,-0.5,0,0.5,1,1.5),   xlab="",ylab="",horizontal = F,add = T, legend = F)

plot(t1,main="",col =rb,breaks = c(-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1),   xlab="",ylab="",horizontal = F,add = T, legend = F)
plot(t2,main="",col =rb,breaks = c(-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1),   xlab="",ylab="",horizontal = F,add = T, legend = F)
plot(t,main="",col =rb,breaks = c(-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1),   xlab="",ylab="",horizontal = F,add = T, legend = F) 
#need to add legend and legend title to figures
