...
for (i in 1:length(jet$ON_Reg1)){
  lines(10:26,rep(jet$ON_Reg1[i],length(10:26)), col = "grey")
}
for (i in 1:length(jet$ON_Reg2)){
  lines(26:56,rep(jet$ON_Reg2[i],length(26:56)), col = "grey")
}
for (i in 1:length(jet$ON_Reg3)){
  lines(56:104,rep(jet$ON_Reg3[i],length(56:104)), col = "grey")
}
for (i in 1:length(jet$ON_Reg4)){
  lines(104:148,rep(jet$ON_Reg3[i],length(104:148)), col = "grey")
}
for (i in 1:length(jet$ON_Reg5)){
  lines(148:180,rep(jet$ON_Reg4[i],length(148:180)), col = "grey")
}
for (i in 1:length(jet$ON_Reg5)){
  lines(-180:-146,rep(jet$ON_Reg5[i],length(-180:-146)), col = "grey")
}
for (i in 1:length(jet$ON_Reg6)){
  lines(-146:-98,rep(jet$ON_Reg6[i],length(-146:-98)), col = "grey")
}
for (i in 1:length(jet$ON_Reg7)){
  lines(-98:-66,rep(jet$ON_Reg7[i],length(-98:-66)), col = "grey")
}
for (i in 1:length(jet$ON_Reg8)){
  lines(-66:-34,rep(jet$ON_Reg7[i],length(-66:-34)), col = "grey")
}
for (i in 1:length(jet$ON_Reg9)){
  lines(-34:-10,rep(jet$ON_Reg7[i],length(-34:-10)), col = "grey")
}
abline(v = 10)
abline(v = 26)
abline(v = 56)
...
plot(j2,main="",col =rb,breaks = c(-2,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,2),   xlab="",ylab="",horizontal = F,add = T, legend = F)
...
plot(t,main="",col =rb,breaks = c(-2,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,2),   xlab="",ylab="",horizontal = F,add = T, legend = F)
plot(t2,main="",col =rb,breaks = c(-2,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,2),   xlab="",ylab="",horizontal = F,add = F, legend = T)
...
##########################################################################################################################
t1 <- merge(j2,j3,j4,j5,tolerance = 0.5)
#map("world", xlim=c(20,180),ylim=c(latmin,latmax), fill = TRUE, col = "light gray", border="light gray")#, wrap=c(-180,180),add = F) 
map("world", xlim=c(-20,180),ylim=c(latmin,latmax), fill = TRUE, col = "light gray", border="light gray")#, wrap=c(-180,180),add = F) 
plot(t1,add = T,legend = F)
...
#nothing in j6
t <- merge(j5b,j6,j7,j8,j9, tolerance = 0.5) 
map("world", xlim=c(-180,8),ylim=c(latmin,latmax), fill = TRUE, col = "light gray", border="light gray")#, wrap=c(-180,180),add = F) 
#t2 <- merge(j4,j5, tolerance = 0.5) 
plot(t,add = T, legend = F)
# Plot all 
...
plot(t,main="",col =rb,breaks = c(-1,-0.75,-0.5,-0.25,0,0.25,0.5,0.75,1),   xlab="",ylab="",horizontal = F,add = T, legend = F)
